...
#' F1-score
#'
#' `f1_score()` Implements a function that calculates the harmonic mean of
#' precision and recall of predicted labels and a vector of true values. Its
#' values range from 0 to 1, where 0 would be a harmonic mean in which one or
#' both of precision or recall are 0 and 1 where both parameters are 1.
#' @param pred vector of predicted labels derived from some model, such as
#'   \link{textmodel_mlp}, which is being subjected to evaluation
#' @param true a vector of known labels that are used to evaluate model
#'   performance
#' @param by_class estimates a separate f1-score score for every class of the
#'   true vector
...
#' Accuracy
#'
#' `accuracy()` Implements a function that calculates the proportion of positive
#' and negative values that have been correctly identified by a machine learning
#' model and a vector of true values. It is calculated by calculating the
#' quotient of the total correctly identified labels and the total number of
#' labels. Its values range from 0 to 1, where 0 would indicate that no
#' predicted labels were correct and 1 would indicate that all predicted labels
#' were correct.
#' @param pred vector of predicted labels derived from some model, such as
#'   \link{textmodel_mlp}, which is being subjected to evaluation
#' @param true a vector of known labels that are used to evaluate model
