...
data_EPcoaldebate_subset$ep_group <- as.character(data_EPcoaldebate_subset$ep_group)
...
metacorpus(data_corpus_EPcoaldebate, "source") <- "Debate 'State aid to facilitate the closure of 
uncompetitive coal mines.' (23 November 2010). URL http://bit.ly/EP-Coal-Aid-Debate."
